 ...
 *   node scripts/import-wikipedia.mjs <wiki-url> --parent=<nodeRef> [--dry-run] [--lang=zh|en] [--translate] [--translate-engine=auto|mymemory|google]
 *
 * 示例:
 *   node scripts/import-wikipedia.mjs https://zh.wikipedia.org/wiki/数据库 --parent=n_55jiel25
 *   node scripts/import-wikipedia.mjs https://en.wikipedia.org/wiki/Database --parent=n_55jiel25 --dry-run
 *   node scripts/import-wikipedia.mjs https://en.wikipedia.org/wiki/ACID --parent=n_55jiel25 --translate
 *
 * 翻译:
...
async function buildMarkdown(title, sectionTree, lang, wikiUrlStr, doTranslate) {
  ...
  let md = `# ${headTitle}\n\n> 来源：[维基百科 ${lang} 条目](${wikiUrlStr})  \n> 整理日期：${date}  \n> 说明：由 \`scripts/import-wikipedia.mjs\` 自动从维基 wikitext 转换为 Markdown，${transNote}。\n\n---\n\n`;
...
function printUsage() {
  console.error('用法:');
  console.error('  node scripts/import-wikipedia.mjs --interactive');
  console.error('  node scripts/import-wikipedia.mjs <wiki-url> --parent=<nodeRef> [--dry-run] [--lang=zh] [--translate] [--translate-engine=auto|mymemory|google]');
}
